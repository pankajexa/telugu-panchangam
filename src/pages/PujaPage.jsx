...
export default function PujaPage() {
  ...
  return (
    <div style={styles.container}>
      <h1 style={{ ...styles.title, fontFamily: font }}>{t('puja.title')}</h1>
      <p style={styles.subtitle}>{t('puja.subtitle')}</p>
            ...
            <div key={item.name}>
              <div style={styles.itemRow}>
                ...
                <div style={styles.cardContent}>
                  <span style={{ ...styles.cardName, fontFamily: font }}>{item.name}</span>
